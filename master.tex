...
\setmonofont[Scale=0.9]{LFT Etica Mono}
...
\author{$for(author)$\normalsize{$author.name$}\thanks{$author.affiliation$, $author.address$$if(author.email)$, $author.email$. $endif$$if(author.thanks)$$author.thanks$$endif$} $sep$ \and $endfor$}
...
\titlespacing*{\subparagraph}{0em}{.25em}{0em}
...
\titleformat{\subsection}[hang]
  ...
  {}
\titleformat{\subsubsection}[hang]
  {\Large\bfseries\rmfamily\color{Maroon}}
  {\thesubsubsection}
  {1em}
  {}
\titleformat{\paragraph}[hang]
...
\newtcolorbox{BoxQuote}{colback=Maroon!5!white,colframe=Maroon,toprule=0mm,bottomrule=0mm,leftrule=3mm,rightrule=0mm,boxsep=0mm}
\AtBeginEnvironment{quote}{\sffamily\small}
\renewenvironment{quote}{\begin{BoxQuote}}{\end{BoxQuote}}
