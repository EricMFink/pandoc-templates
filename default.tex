...
\titleformat{\subsection}[hang]
  {\Large\bfseries\sffamily\color{Maroon}}
  {\thesubsection}
  {1em}
  {}
...
\titleformat{\paragraph}[hang]
  {\large\rmfamily\color{Maroon}}
  {\thesubsubsection ~~}
  {0em}
  {}
  [\vspace{-1.5em}\textcolor{Maroon}{\rule{\textwidth}{.5pt}}]
...
\newtcolorbox{BoxQuote}{flush right,colback=Maroon!5!white,colframe=Maroon,toprule=0mm,bottomrule=0mm,leftrule=3mm,rightrule=0mm,boxsep=0mm,width=.95\linewidth}
...
\author{$for(author)$\normalsize{$author.name$}\thanks{$author.affiliation$, $author.address$. $author.email$. $author.thanks$} $sep$ \and $endfor$}

\date{}

% Aligns "thanks" footnote symbol with left margin
...
$if(subtitle)$
\vspace{2mm}
\sffamily\centering\Large\itshape{\color{Maroon}{$subtitle$}} \\
$endif$
\vspace{5mm}
\end{flushleft}
$endif$
