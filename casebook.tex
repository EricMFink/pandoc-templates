...
\titleformat{\section}%
  [block]
  {\newpage\begin{fullwidth}\raggedright\sffamily\Huge\color{DullRed}}
  {\thesection ~~}
  {0em}
  {}
  [\end{fullwidth}]
...
\titleformat{\subsection}
  [block]
  {\needspace{2\baselineskip}\raggedright\sffamily\huge\color{DullRed}}
  {\thesubsection ~~}
  {0em}
  {}
  []
...
\titleformat{\subsubsection}
  [block]
  {\raggedright\rmfamily\LARGE\color{DullRed}}
  {\thesubsubsection ~~}
  {0em}
  {}
  [\vspace{-1em}\textcolor{DullRed}{\rule{\textwidth}{2pt}}]
...
\newcommand*{\halfsep}{\noindent\hfil\textcolor{DullRed}{\rule{0.5\textwidth}{.5pt}}\hfil}

\newcommand*{\fullsep}{\newline\noindent\textcolor{DullRed}{\rule{\textwidth}{2pt}}}
...
\renewcommand\cfttoctitlefont{\Huge\sffamily\textcolor{DullRed}}
\renewcommand\cftsecfont{\rmfamily\LARGE}
\renewcommand\cftsubsecfont{\rmfamily\Large}
\renewcommand\cftsubsubsecfont{\rmfamily\large}
...
\renewcommand\cftsubsubsecafterpnum{\vskip0mm}
...
\titlecontents{paragraph}% <section-type>
  [6em]% <left>
  {}% <above-code>
  {\vskip0mm\normalsize \thecontentslabel\quad}% <numbered-entry-format>
